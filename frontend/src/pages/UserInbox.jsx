...
const UserInbox = () => {
  ...
  useEffect(() => {
    ...
    const messageList = await axios
      ...
      setConversations(messageList.data.conversations);
  ...
  return (
    <div
      className={`w-full flex p-3 px-3 ${
        active === index ? "bg-[#3b4c51af]" : "bg-transparent"
      }  cursor-pointer`}
      onClick={(e) =>
        setActive(index) ||
    ...
    >
      <div className="relative">
        ...
        />
        {online ? (
          <div className=" w-[12px] h-[12px] rounded-full bg-green-400 absolute top-[1px] right-[1px]"></div>
        ) : (
          <div className=" w-[12px] h-[12px] rounded-full bg-[#cecccc7e] absolute top-[1px] right-[1px]"></div>
        )}
      </div>
      <div className=" pl-3">
...
const SellerInbox = ({
  ...
  return (
    <div className="w-full min-h-full flex flex-col justify-between ">
      ...
      {/* {messages} */}
      <div className="h-[65vh] py-3 px-6 overflow-y-scroll">
        {messages &&
            ...
            >
             ...
             {item.text !== "" && (
                <div>
                  ...
                  >
                    <p className=" font-Poppins font-[500]">{item.text}</p>
                  </div>
