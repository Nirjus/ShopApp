      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            min={today}
            placeholder="Enter the number of Stock of the product..."
          />
        </div>
        <br />
        <div>
        ...
        <div>
          ...
          <div>
            <input
              type="submit"
              value="CREATE"
              className=" mt-2 appearance-none block w-full px-3 h-[35px] border bg-orange-300 font-[700] border-gray-800 rounded-[5px] placeholder-blue-800 focus:outline-none focus:ring-blue-500 sm:text-sm hover:bg-orange-400"
            />
          </div>
        </div>
      </form>
